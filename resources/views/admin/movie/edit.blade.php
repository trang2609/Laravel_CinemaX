                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input class="form-control" name="director" id="moviedirector" type="text" value="{!! $movie['director'] !!}"
                                ...
                                <div class="col-md-12">
                                <div class="form-group">
                                        <label for="director" class="form-control-label">Diễn viên</label>
                                        <div class="form-group">
                                            <input class="form-control" name="cast" id="moviecast" type="text" value="{!! $movie['cast'] !!}"
                                                   placeholder="Nhập tên...">
                                        </div>
                                </div>
                                </div>
