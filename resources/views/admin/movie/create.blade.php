                        ...
                        <form method="post" action="/admin/movie/create" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="director">Nhập tên đạo diễn</label>
                                            <input class="form-control" name="director" id="moviedirector" type="text" value=""
                                    ...
                                    <div class="col-md-12">
                                    <div class="form-group">
                                            <label for="director">Nhập tên diễn viênviên</label>
                                            <input class="form-control" name="cast" id="moviecast" type="text" value=""
                                                   placeholder="Nhập tên...">
