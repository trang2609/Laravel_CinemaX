...
<div id="photo" class="ticket" >
    <div class="left">
        <div class="ticket-info">
            ...
            <div class="time">
                 <p>
                     <span>Từ</span> {!! date('H:i A', strtotime($ticket->schedule->startTime)) !!}
...
<div style="display: flex; justify-content: center; letter-spacing: 20px;">
    <div style="display: flex;">
        <form action="/">
            <button  type="submit" class="btn btn-outline-light border-2 fw-bold">Quay lại</button>&nbsp
        </form>
        <div style="display: inline-block" >
            <button id="download" class="btn btn-outline-light border-2 fw-bold">Tải về</button>
        </div>
    </div>
</div>
