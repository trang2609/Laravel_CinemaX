        ...
        <nav aria-label="breadcrumb mt-5">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                    <a href="#" class="link link-secondary disabled text-decoration-none">Đặt vé</a>
                </li>
            </ol>
        </nav>
                        ...
                        <div class="col-12 col-md-9 col-lg-12">
                            <div class="card-body">
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item bg-transparent text-light border-0">
                                        Giới hạn độ tuổi: <strong class="ps-2">
                ...
                <div id="mainTicket">
                    ...
                    <div id="Payment" class="mt-5 collapse" data-bs-parent="#mainTicket">
                        <form id="paymentForm" action="/payment/create" method="post">
                            ...
                            <h4 class="mt-4">Mã khuyến mại</h4>
                                ...
                                <div class="row row-cols-1">
                                    <div class="form-check pe-4" id="bankCode">
                                        <div class="input-group">
                                            ...
                                            <a id="btn_apply_discount" class="btn btn-success">Áp dụng</a>
                                        </div>
                                    </div>
